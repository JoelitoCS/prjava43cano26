...
public class Prjava43cano26 extends Frame 
   ...
   public Prjava43cano26 () { 
      ...
      setTitle("nova finestra prjava43cano26");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43cano26();  // Let the construct do the job 
   } 
